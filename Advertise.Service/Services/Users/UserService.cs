...
{
    /// <inheritdoc cref="UserManager{TUser,TKey}" />
    /// <summary>
    /// </summary>
    public class UserService : UserManager<User, Guid>, IUserService
    {
        ...
        {
            return ApplicationSecurityStampValidator
                .OnValidateIdentity(TimeSpan.FromMinutes(0), GenerateUserIdentityAsync, identity => Guid.Parse(identity.GetUserId()));
        }
        ...
        //{
        //    return Advertise.Core.Infrastructure.DependencyManagement.ContainerManager.Container
