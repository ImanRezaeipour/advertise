...
namespace Advertise.Data.Extensions
{
    ...
    public static class DbContextExtensions
    {
        ...
        /// <returns></returns>
        public static string DbName(this IUnitOfWork context)
        {
        ...
        public static int? GetColumnMaxLength(this IUnitOfWork context, string entityTypeName, string columnName)
        {
        ...
        /// <returns></returns>
        public static IDictionary<string, int> GetColumnsMaxLength(this IUnitOfWork context, string entityTypeName, params string[] columnNames)
        {
            int temp;
        ...
        /// <param name="columnNames">Column names</param>
        /// <returns></returns>
        public static IDictionary<string, decimal> GetDecimalMaxValue(this IUnitOfWork context, string entityTypeName, params string[] columnNames)
        {
        ...
        public static string GetTableName<T>(this IUnitOfWork context) where T : BaseEntity
        {
        ...
        /// <returns></returns>
        public static T LoadDatabaseCopy<T>(this IUnitOfWork context, T currentCopy) where T : BaseEntity
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadOriginalCopy<T>(this IUnitOfWork context, T currentCopy) where T : BaseEntity
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        private static DbContext CastOrThrow(IUnitOfWork context)
        {
        ...
        /// <param name="edmTypeName"></param>
        /// <param name="columnNames"></param>
        /// <returns></returns>
        private static Dictionary<string, ReadOnlyMetadataCollection<Facet>> GetFildFacets(this IUnitOfWork context, string entityTypeName, string edmTypeName, params string[] columnNames)
        {
        ...
        /// <returns></returns>
        private static T InnerGetCopy<T>(IUnitOfWork context, T currentCopy, Func<DbEntityEntry<T>, DbPropertyValues> func) where T : BaseEntity
        {
