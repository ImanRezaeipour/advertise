...
namespace Advertise.Web.Controllers
{
    public partial class PlanDiscountController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _AddItem = "~/Views/PlanDiscount/_AddItem.cshtml";
            public readonly string _Item = "~/Views/PlanDiscount/_Item.cshtml";
            public readonly string _ListMore = "~/Views/PlanDiscount/_ListMore.cshtml";
            public readonly string Create = "~/Views/PlanDiscount/Create.cshtml";
            public readonly string Edit = "~/Views/PlanDiscount/Edit.cshtml";
            public readonly string List = "~/Views/PlanDiscount/List.cshtml";
        }
    }
    ...
    public partial class T4MVC_PlanDiscountController : Advertise.Web.Controllers.PlanDiscountController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.PlanDiscount.PlanDiscountCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Advertise.Core.Models.PlanDiscount.PlanDiscountCreateViewModel viewModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.PlanDiscount.PlanDiscountEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Advertise.Core.Models.PlanDiscount.PlanDiscountEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.PlanDiscount.PlanDiscountSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> List(Advertise.Core.Models.PlanDiscount.PlanDiscountSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.List);
