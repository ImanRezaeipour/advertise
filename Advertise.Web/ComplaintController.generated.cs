...
namespace Advertise.Web.Controllers
{
    public partial class ComplaintController
    {
        ...
        protected ComplaintController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ComplaintController Actions { get { return MVC.Complaint; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Complaint";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Complaint";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Item = "~/Views/Complaint/_Item.cshtml";
            public readonly string _ListMore = "~/Views/Complaint/_ListMore.cshtml";
            public readonly string Create = "~/Views/Complaint/Create.cshtml";
            public readonly string Detail = "~/Views/Complaint/Detail.cshtml";
            public readonly string List = "~/Views/Complaint/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ComplaintController : Advertise.Web.Controllers.ComplaintController
    {
        public T4MVC_ComplaintController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.Complaint.ComplaintCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Advertise.Core.Models.Complaint.ComplaintCreateViewModel viewModel)
        {
        ...
        [NonAction]
        partial void DetailOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid? id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Detail(System.Guid? id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Detail);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.Complaint.ComplaintSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> List(Advertise.Core.Models.Complaint.ComplaintSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.List);
