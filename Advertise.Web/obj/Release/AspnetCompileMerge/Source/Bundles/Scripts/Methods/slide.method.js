...
var getBackgroundShadow = function (elem) {
    var bgShadow = $(elem).parents('.product-item').children('.bg-shadow');
    return bgShadow;
}
...
var getShadow = function (elem) {
    var shadow = $(elem).parents('.product-item').children('.slider-shadow');
    return shadow;
}
...
var getNames = function (shadowElem) {
    var parent = $(shadowElem).parents('.product-item');
    var company = parent.children('.part-four').children('a').children('p').text();
    var album = parent.children('.novinak-title-link').children('p').text();
