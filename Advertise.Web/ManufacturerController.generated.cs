...
namespace Advertise.Web.Controllers
{
    public partial class ManufacturerController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _AddItem = "~/Views/Manufacturer/_AddItem.cshtml";
            public readonly string _Item = "~/Views/Manufacturer/_Item.cshtml";
            public readonly string _ListMore = "~/Views/Manufacturer/_ListMore.cshtml";
            public readonly string Create = "~/Views/Manufacturer/Create.cshtml";
            public readonly string Edit = "~/Views/Manufacturer/Edit.cshtml";
            public readonly string List = "~/Views/Manufacturer/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ManufacturerController : Advertise.Web.Controllers.ManufacturerController
    {
        public T4MVC_ManufacturerController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.Manufacturer.ManufacturerCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Advertise.Core.Models.Manufacturer.ManufacturerCreateViewModel viewModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.Manufacturer.ManufacturerEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Advertise.Core.Models.Manufacturer.ManufacturerEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.Manufacturer.ManufacturerSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> List(Advertise.Core.Models.Manufacturer.ManufacturerSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.List);
